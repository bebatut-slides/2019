![Cover art](images/TheCarpentries_logo.png) <!-- .element width="60%" -->
...
![](images/Defining-big-data1.png)  <!-- .element width="80%" -->
...
![](images/Barone_et_al_2017.png) <!-- .element width="90%" -->
...
## How do we scale <br>data and software skills <br>along with data production?
...
![](images/workshop.jpg) <!-- .element width="80%" -->
...
![](images/ten_thousand.png) <!-- .element width="60%" -->
...
![](images/the_carpentries_schema.svg) <!-- .element width="70%" -->

----

![](images/data_carpentry_schema.svg) <!-- .element width="90%" -->
...
![](images/software_carpentry_schema.svg) <!-- .element width="90%" -->
...
![](images/library_carpentry_schema.svg) <!-- .element width="90%" -->
...
![](images/workshops.svg) <!-- .element width="70%" -->
...
![](images/learners.svg) <!-- .element width="60%" -->
...
![](images/recommended.png) <!-- .element width="100%" -->

![](images/dc-paired-data-mean-1.png) <!-- .element width="100%" -->
...
![](images/after_6months.png) <!-- .element width="100%" -->
...
![](images/online_collaborative_material.svg) <!-- .element width="100%" -->
...
![](images/community.jpg) <!-- .element width="90%" -->
...
![](images/instructor_map.png) <!-- .element width="60%" -->
...
![](images/mentoring.svg) <!-- .element width="70%" -->

---
## And ELIXIR in that?

![](images/elixir_carpentries.png) <!-- .element width="100%" -->
...
![](images/workshops_from_tess.svg) <!-- .element width="90%" -->
...
![](images/4OSS.png) <!-- .element width="80%" -->
